...
.EXAMPLE
   New-BcapSession 10.1.2.3 sadProcessor -Port 1234
   Will prompt for password if ommitted
.EXAMPLE
   $ServerIPList | BcapSession.New sadProcessor -NoSSL
...
.EXAMPLE
   ...
   Note: Can ommit quotes if no semi-colon
.EXAMPLE
