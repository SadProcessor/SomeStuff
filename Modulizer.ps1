...
function Write-EmpireModule{
    ...
    Process{
        ...
        if(!$SourceFile){
            ...
            switch($host.Name){
                # if Console -> Break
                'ConsoleHost'{Write-Warning 'Must specify Source File...¯\_(ツ)_/¯'; Break}
        ...
        Else{
            ...
            else{Write-Warning 'File not found...¯\_(ツ)_/¯ ';Break}
            }
        ...
        Else{Write-Warning 'Empty Script Content...¯\_(ツ)_/¯ '; Break}
        # If empty AST -> Break
        if($AST.Extent.text -eq ''){Write-Warning 'Empty Script Content...¯\_(ツ)_/¯ '; Break}
        # If error in input > Break
        if($Err -ne $Null){Write-Warning 'Invalid Source code...¯\_(ツ)_/¯ ';Break}
        ...
        if($Function){
            ...
            # if not found
            if(!$FunctAST){Write-Warning 'Function not found...¯\_(ツ)_/¯ ';Break}
            }
