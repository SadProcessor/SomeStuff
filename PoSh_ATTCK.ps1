...
Update-TypeData -TypeName ATTCKTechnique -DefaultDisplayPropertySet Name,Description -Force
...
Update-TypeData -TypeName ATTCKSoftware -DefaultDisplayPropertySet Name,Description -Force
...
Update-TypeData -TypeName ATTCKGroup -DefaultDisplayPropertySet Name,Description -Force
...
function Get-ATTCKnowledge{
    ...
    Else{
        ...
        # Else Cmdlet Memo
            ...
            [PSCustomObject]@{Cmdlet='Get-ATTCKTechnique';Alias='ATTCK-Technique';Help='Help ATTCK-Technique'}
